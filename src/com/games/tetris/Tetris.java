...
import static com.util.Misc.*;

public abstract class Tetris extends AbstractApplication {

//    public static final Matrix BOARD = new Matrix(12, 24);
//    public static final int UNITY = 10;
//    public static final int WIDTH = BOARD.getWidth() * UNITY, HEIGHT = BOARD.getHeight() * UNITY;
//
//    private Matrix activeShape;
//
...
//                if (BOARD.getValueAt(x, y) != Matrix.EMPTY) {
...
//
//        if (gameOver) {
//            renderer.drawText("PERDEU", 0, 0, 1f, Color.WHITE.getRGB());
//        }
//    }
//
...
//
//        Matrix sel = BOARD.select(activeShape.getX(), activeShape.getY(), activeShape.getX() + (activeShape.getWidth() - 1), activeShape.getY() + (activeShape.getHeight() - 1));
//        Matrix blank = new Matrix(sel.getWidth(), sel.getHeight());
